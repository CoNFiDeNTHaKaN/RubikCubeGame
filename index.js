...
! function() {
    var DIST_DRAG = 30,
        ...
        row4 = [
            [pf1s[0], pf1s[3], pf1s[6]], 
            [pf6s[0], pf6s[3], pf6s[6]], 
            [pf3s[8], pf3s[5], pf3s[2]], 
            [pf5s[0], pf5s[3], pf5s[6]] 
        ],
        row5 = [ 
            [pf1s[1], pf1s[4], pf1s[7]], 
            [pf6s[1], pf6s[4], pf6s[7]], 
            [pf3s[7], pf3s[4], pf3s[1]], 
            [pf5s[1], pf5s[4], pf5s[7]] 
        ],
        row6 = [ 
            [pf1s[2], pf1s[5], pf1s[8]],
            [pf6s[2], pf6s[5], pf6s[8]], 
            [pf3s[6], pf3s[3], pf3s[0]], 
            [pf5s[2], pf5s[5], pf5s[8]] 
        ],
        row7 = [
    ...
    // mousemove e.button chrome 41 e.buttons
    ...
    function getDir(f, angle) {
        ...
        // up = 1, r = right = 2, dn = down = 3, l = left = 4
    ...
    function onMouseUp(e) {
        ...
        if (roll.dragging) {
            ...
            if (Math.abs(roll.y - e.clientY) > DIST_DRAG || Math.abs(roll.x - e.clientX) > DIST_DRAG) {
                ...
                // 1  roll row 1, 2, 3, 4, 5, 6 一
                // f2 roll row 1, 2, 3, 7, 8, 9 一
                // f5 roll row 4, 5, 6, 7, 8, 9 一
                if (f == 1) {
                    if (dir == 1 || dir == 3) { 
